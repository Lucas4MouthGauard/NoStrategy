  ...
  const charts = [
    {
      ...
      description: 'FOMO效应爆发！价格疯狂上涨，错过就是损失！',
    ...
    },
    {
      ...
      description: '突破关键阻力位，新一轮上涨开始！',
      data: generateFomoCandleData('突破上涨')
    }
  ]
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-300 text-lg">
          图表是骗人的，感觉才是真实的！但这里的数据看起来很专业！
        </p>
      </div>

      <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/30">
        <div className="text-center mb-6">
          <div className="text-6xl mb-4">{charts[currentChart].emoji}</div>
          <h3 className="text-3xl font-bold text-white mb-2">
            {charts[currentChart].type}
          </h3>
          <p className="text-gray-300 text-lg">{charts[currentChart].description}</p>
        </div>

        {/* 控制面板 */}
        <div className="flex flex-wrap justify-center gap-4 mb-6">
          <div className="flex items-center space-x-2">
            <span className="text-gray-300">时间周期:</span>
            <select
              value={timeframe}
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="rounded"
            />
            <label htmlFor="showVolume" className="text-gray-300">成交量</label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="rounded"
            />
            <label htmlFor="showMA" className="text-gray-300">均线</label>
          </div>
        ...
        <div className="mt-6 bg-black/30 rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-white font-semibold">🚀 快速交易</h4>
            <div className="flex items-center space-x-2">
              {!connected ? (
          ...
          <div className="flex space-x-4">
            <button
              ...
              disabled={!connected}
              className="flex-1 bg-green-600 hover:bg-green-700 disabled:opacity-50 text-white py-2 px-4 rounded-lg font-semibold"
            >
              🟢 买入
            </button>
            <button
              ...
              disabled={!connected}
              className="flex-1 bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white py-2 px-4 rounded-lg font-semibold"
            >
              🔴 卖出
            </button>
            <button
        ...
        {trades.length > 0 && (
          <div className="mt-4 bg-black/30 rounded-lg p-4">
            <h4 className="text-white font-semibold mb-2">📋 交易历史</h4>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-sm">
            每8秒自动切换图表类型 | 鼠标悬停查看详细数据 | FOMO指数实时更新
          </p>
      ...
      {/* FOMO状态指示器 */}
      <div className="bg-gradient-to-r from-green-600/20 to-red-600/20 rounded-2xl p-6 border border-green-500/30">
        <div className="text-center space-y-4">
          <h3 className="text-2xl font-bold text-white">🔥 FOMO指数</h3>
          <div className="text-4xl font-bold text-green-400">{fomoLevel.toFixed(0)}%</div>
          ...
          <p className="text-gray-300">
            {fomoLevel > 80 ? '🚀 极度FOMO！快上车！' :
             fomoLevel > 60 ? '📈 强烈FOMO！机会难得！' :
             fomoLevel > 40 ? '😐 中等FOMO，谨慎操作' :
             fomoLevel > 20 ? '😴 轻微FOMO，保持冷静' : '💤 无FOMO，市场平静'}
          </p>
        </div>
      </div>
    </div>
